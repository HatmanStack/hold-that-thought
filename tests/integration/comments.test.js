...
describe('comments API Integration Tests', () => {
  ...
  it('pOST /comments/{itemId} creates new comment', async () => {
  ...
  it('pOST /comments/{itemId} sanitizes HTML', async () => {
  ...
  it('pOST /comments/{itemId} rejects text longer than 2000 chars', async () => {
  ...
  it('gET /comments/{itemId} lists comments', async () => {
  ...
  it('pUT /comments/{itemId}/{commentId} edits comment', async () => {
    if (!createdCommentId) {
  ...
  it('dELETE /comments/{itemId}/{commentId} soft-deletes comment', async () => {
    if (!createdCommentId) {
