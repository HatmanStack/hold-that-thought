...
describe('Reactions API Integration Tests', () => {
  ...
  test('POST /reactions/{commentId} adds reaction', async () => {
    if (!testCommentId) {
  ...
  test('POST /reactions/{commentId} removes reaction on second call', async () => {
    if (!testCommentId) {
      console.log('Skipping test - no comment created');
      return;
    }
  ...
  test('GET /reactions/{commentId} lists reactions', async () => {
    if (!testCommentId) {
      console.log('Skipping test - no comment created');
      return;
    }
