<script lang="ts">
  ...
  import { currentUser, authStore } from '$lib/auth/auth-store'
  ...
  <div class="card w-full max-w-lg mx-auto bg-base-100 shadow-xl">
    <div class="card-body text-center">
      ...
      <div class="space-y-4">
        ...
        <!-- Instructions -->
        <div class="bg-info/10 border border-info/20 rounded-lg p-4 text-left">
          <h3 class="font-semibold text-info mb-2">What happens next?</h3>
