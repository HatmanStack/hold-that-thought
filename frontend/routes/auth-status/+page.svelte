  ...
  <div class='mb-8'>
    ...
    {#if data.cognitoConfig.isConfigured}
      <div class='bg-green-50 border border-green-200 rounded-lg p-4'>
        <div class='flex items-center mb-2'>
          <span class='text-xl mr-2 text-green-600'>✅</span>
    ...
    {:else}
      <div class='border rounded-lg p-4 bg-yellow-50 border-yellow-200'>
        <div class='flex items-center mb-2'>
          <span class='text-xl mr-2 text-yellow-600'>⚠️</span>
          <span class='font-semibold text-yellow-800'>Cognito configuration incomplete</span>
        </div>
        <div class='text-sm mb-3 text-yellow-700'>
        ...
        <div class='text-sm space-y-1'>
          <div class='flex items-center'>
            ...
            {/if}
            <code class='px-2 py-1 rounded bg-gray-100'>PUBLIC_AWS_REGION</code>
            {#if data.cognitoConfig.region}
...
aws cloudformation deploy --template-file cognito-user-pool.yaml --stack-name my-app-cognito --capabilities CAPABILITY_NAMED_IAM</pre>
  ...
  {#if data.cognitoConfig.isConfigured}
    <div class='bg-gray-50 border border-gray-200 rounded-lg p-4'>
      ...
      <div class='space-y-2'>
        <div>
          <a href='/admin' class='underline text-blue-600 hover:text-blue-800'>
